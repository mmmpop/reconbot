...
struct station stationList[] = {{"mp_iphone","bonjour!", true}};
 ...
 * the ssid to force connections to specific networks even when the ssid's collide,v
 */
